<h2><a href="https://leetcode.com/problems/student-attendance-record-i/?envType=problem-list-v2&envId=string">551. Student Attendance Record I</a></h2><h3>Easy</h3><hr><p>You are given a string <code>s</code> representing an attendance record for a student where each character signifies whether the student was absent, late, or present on that day. The record only contains the following three characters:</p>
